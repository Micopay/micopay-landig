      ...
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <button className="px-8 py-4 bg-primary text-white font-bold rounded-2xl shadow-lg shadow-primary/20 hover:bg-accent-dark transition-all hover:scale-[1.02] active:scale-[0.98]">
              {t.merchantCTA.cta}
            </button>
          </div>

          <div className="bg-surface rounded-3xl p-8 shadow-xl border border-border-light transition-colors duration-300">
