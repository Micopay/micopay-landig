...
export default function TrustSecurity() {
  ...
  return (
    <section id="seguridad" className="section-padding bg-gradient-to-b from-white to-primary-light/30">
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {t.trust.features.map((feature, index) => (
            <div
              key={feature.title}
              className="relative bg-white rounded-3xl p-8 shadow-lg shadow-primary/5 border border-border-light"
            >
              {/* Icon */}
        ...
        <div className="mt-16 bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-border-light">
