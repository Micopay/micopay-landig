            ...
            <div className="relative bg-surface rounded-3xl shadow-2xl p-6 border border-border-light overflow-hidden transition-colors duration-300">
              ...
              <div className="aspect-square bg-gradient-to-br from-primary-light/50 to-accent/20 rounded-2xl relative overflow-hidden">
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                  <div className="w-14 h-14 bg-surface rounded-full flex items-center justify-center shadow-xl border-4 border-primary">
              ...
              {/* Floating card */}
              <div className="absolute bottom-8 left-4 right-4 bg-surface-elevated rounded-2xl shadow-xl p-4 border border-border-light transition-colors duration-300">
